...
export const en: Record<LocaleKey, string> = {
  ...
  // Still-image shots
  'shots_need_image': 'Pick an illustration (still image) in Assets first',
  ...
  'shot_motion_amount': 'Camera move amount',
  ...
  'motion_intensity': 'Effect amount',
