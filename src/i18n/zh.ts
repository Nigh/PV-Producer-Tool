export const zh = {
  ...
  'effects_library': '效果库',
  'theme_light': '浅色主题',
  'shots_need_image': '请先在「素材」选择一张曲绘（静态图片）并点击「应用」',
  'shot_hint': '点选歌词行，再拖框取景（比例锁定为当前画幅）；框内拖动移动，右下角缩放',
  'shot_unset': '本句尚未取景 — 在图上拖拽添加',
  'shot_pick_line': '先在左侧选中一句歌词',
  'shot_exit_focus': '退出选中',
  'shot_single_edit': '单句编辑',
  'shot_motion_amount': '运动幅度',
  'loop_line': '句内循环',
  'loop_exit': '退出句内循环',
  'shot_fill_unset': '未设行填满画幅',
  'shot_copy_prev': '复制上一镜',
  'shot_in': '入场 In',
  'shot_out': '出场 Out',
  'shot_motion': '运动 Motion',
  'shot_clear': '清除',
  'shot_preview': '预览',
  'shot_template': '模板 Template',
  'shot_tpl_inherit': '沿用上一镜',
  'shot_follow_global': '跟随全局',
  'shot_reset_overrides': '重置参数',
  'shot_tpl_manage': '模板管理',
  'tr_cut': '硬切 Cut',
  'tr_fade': '淡入淡出 Fade',
  'tr_slide': '滑动 Slide',
  'tr_zoom': '急推 Zoom',
  ...
  'load_fonts_failed': '获取本机字体失败（可能未授权）',
  'text_label': '歌词 LRC（须带时间戳）',
  'expand': '展开',
  'collapse': '收起',
  'seg_duration': '段落间隔',
  'anim_speed': '动画速度',
  ...
  'aspect_ratio': '画幅 Aspect',
  'aspect_16_9': '16:9 横屏',
  'aspect_9_16': '9:16 竖屏',
  'lrc_required': '请使用带时间戳的 LRC 歌词',
